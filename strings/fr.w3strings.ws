...
function _test_verifyW3strings() : int {
    ...
    if (!assertTrue(GetLocStringById(2116006002) == "Recommandé", "w3string.byId: 2116006002")) failed += 1;
    ...
    if (!assertTrue(GetLocStringByKey("preset_value_jl102_default") == "Recommandé", "w3string.byKey: preset_value_jl102_default")) failed += 1;
